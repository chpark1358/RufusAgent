...
export const DEFAULT_PUBLIC_REMOTE_DASHBOARD_BASE_URL = `${PUBLIC_REMOTE_PLANNER_ORIGIN}/rufus-agent-dashboard/`;
...
export function deriveRemoteDashboardBaseUrlFromPlannerUrl(rawPlannerUrl) {
  ...
  try {
    return new URL("/rufus-agent-dashboard/", new URL(plannerUrl).origin).toString();
  } catch {
    return DEFAULT_PUBLIC_REMOTE_DASHBOARD_BASE_URL;
  }
}
