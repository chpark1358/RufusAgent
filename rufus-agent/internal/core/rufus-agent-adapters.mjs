...
import { writeRunAuthorityArtifacts } from "./rufus-agent-authority-artifacts.mjs";
import { CLAUDE_ADAPTER_BACKEND, CLAUDE_ADAPTER_TYPE, claudeCodeAdapter } from "./rufus-agent-claude-code-adapter.mjs";
import { CODEX_ADAPTER_BACKEND, CODEX_ADAPTER_TYPE, codexAdapter } from "./rufus-agent-codex-adapter.mjs";
...
export function defaultAdapterConfig(options = {}) {
  const envType = process.env.RUFUS_AGENT_DEFAULT_ADAPTER_TYPE;
  const envBackend = process.env.RUFUS_AGENT_DEFAULT_ADAPTER_BACKEND;
