...
import { readWorkspaceAuthorityRecord } from "./rufus-agent-authority-artifacts.mjs";
import { resolveRufusAgentBinding } from "./rufus-agent-binding-resolver.mjs";
import { dashboardUrlForWorkspace } from "./rufus-agent-runtime-paths.mjs";
...
export async function resolveCliAuthoritativeBinding(options = {}) {
  ...
  let binding = resolveRufusAgentBinding({
    workspaceRoot,
