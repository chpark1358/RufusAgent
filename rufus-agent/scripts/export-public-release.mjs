...
import { rufusagentInstallRoot } from "../internal/core/rufus-agent-runtime-paths.mjs";
...
function buildGuidance(errorCode, message, extra = {}) {
  return {
    ...
    expected_usage: [
      ...
      "node $RUFUS_AGENT_INSTALL_ROOT/skills/rufus-agent/scripts/export-public-release.mjs --output-dir /abs/output",
      "node $RUFUS_AGENT_INSTALL_ROOT/skills/rufus-agent/scripts/export-public-release.mjs --output-dir /abs/output --bundle-name rufus-agent-public",
      "node $RUFUS_AGENT_INSTALL_ROOT/skills/rufus-agent/scripts/export-public-release.mjs --output-dir /abs/output --force --skip-validate"
    ],
    rules: [
...
const args = {
  ...
  bundleName: `rufus-agent-public-release-${timestampLabel()}`,
  validate: true,
  force: false
};
...
const exportedMultiAgentRoot = resolve(releaseRoot, "rufus-agent");
const exportedRuntimeRoot = resolve(releaseRoot, "rufus-agent-runtime");
