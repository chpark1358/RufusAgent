...
function buildGuidance(errorCode, message, extra = {}) {
  return {
    ...
    message,
    expected_usage: [
      "node $RUFUS_AGENT_INSTALL_ROOT/skills/rufus-agent/scripts/recommend-plan.mjs --creative-draft-file /abs/draft.json --workspace-root /abs/workspace --request-summary \"request summary\"",
      "node $RUFUS_AGENT_INSTALL_ROOT/skills/rufus-agent/scripts/recommend-plan.mjs --creative-draft-json '{\"plan_title\":\"Short title\",\"preferred_language\":\"ko\",\"single_or_multi\":\"multi\",\"multi_agent_beneficial\":true,\"recommendation_summary\":\"...\",\"recommendation_reasons\":[\"...\"],\"subagents\":[...]}' --request-summary \"request summary\"",
      "node $RUFUS_AGENT_INSTALL_ROOT/skills/rufus-agent/scripts/recommend-plan.mjs --creative-draft-file /abs/draft.json --language ko --workspace-root /abs/workspace --db /path/to/rufusagent.sqlite --timeout-ms 180000 --request-summary \"request summary\"",
      "node $RUFUS_AGENT_INSTALL_ROOT/skills/rufus-agent/scripts/recommend-plan.mjs --creative-draft-file /abs/draft.json --workspace-root /abs/workspace --db /path/to/rufusagent.sqlite --dashboard-url http://127.0.0.1:18081 --request-summary \"request summary\""
    ],
    rules: [
