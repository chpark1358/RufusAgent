...
import { defaultAdapterConfig, launchRunWithAdapter, requireAdapter } from "../internal/core/rufus-agent-adapters.mjs";
...
import { createRunSnapshot } from "../internal/core/rufus-agent-run-snapshot.mjs";
import { hasExplicitAdapterConfigEnv, resolveAutoAdapterConfig, resolveMainProviderSessionIdentity } from "../internal/core/rufus-agent-provider-session.mjs";
import { openStore } from "../internal/core/rufus-agent-store.mjs";
import { resolveRufusAgentBinding } from "../internal/core/rufus-agent-binding-resolver.mjs";
import { isStructurallyMultiAgentPlan, validatePlan, validatePlanForAdapter } from "../internal/core/rufus-agent-validation.mjs";
...
if (
  ...
  store.close();
  binding = resolveRufusAgentBinding({
    workspaceRoot: args.workspaceRoot,
